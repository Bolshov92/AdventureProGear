...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) {
        ...
        if ((HttpMethod.POST.matches(method) || HttpMethod.PUT.matches(method) || HttpMethod.DELETE.matches(method))
                ...
                && (path.startsWith("/api/public/sections") || path.startsWith("/api/productAttributes") || path.startsWith("/api/public/products") || path.startsWith("/api/public/categories") || path.startsWith("/api/public/productContent") || path.startsWith("/api/public/category-characteristics") || path.startsWith("/api/public/product-characteristics"))) {
