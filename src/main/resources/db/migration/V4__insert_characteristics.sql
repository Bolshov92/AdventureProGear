...
CREATE SEQUENCE category_characteristics_seq
    START 1
    INCREMENT 1;
/*
...
VALUES
    (nextval('category_characteristics_seq'), 'Тип спорядження', 'STRING', (SELECT id FROM category_ids), 'Tourism Backpacks'),
    (nextval('category_characteristics_seq'), 'Матеріал', 'STRING', (SELECT id FROM category_ids), 'Tourism Backpacks'),
    (nextval('category_characteristics_seq'), 'Вага', 'NUMBER', (SELECT id FROM category_ids), 'Tourism Backpacks'),
    (nextval('category_characteristics_seq'), 'Місткість', 'NUMBER', (SELECT id FROM category_ids), 'Tourism Backpacks'),
    (nextval('category_characteristics_seq'), 'Сезонність', 'STRING', (SELECT id FROM category_ids), 'Tourism Backpacks');
...
INSERT INTO category_characteristics (id, name, data_type, category_id, category_name)
VALUES
    (nextval('category_characteristics_seq'), 'Тип спорядження', 'STRING', (SELECT id FROM category_ids), 'Sleeping Bags'),
    ...
    (nextval('category_characteristics_seq'), 'Сезонність', 'STRING', (SELECT id FROM category_ids), 'Sleeping Bags');
...
INSERT INTO category_characteristics (id, name, data_type, category_id, category_name)
VALUES
    (nextval('category_characteristics_seq'), 'Тип спорядження', 'STRING', (SELECT id FROM category_ids), 'Cooking Gear'),
    ...
    (nextval('category_characteristics_seq'), 'Тип використання', 'STRING', (SELECT id FROM category_ids), 'Cooking Gear');
...
INSERT INTO category_characteristics (id, name, data_type, category_id, category_name)
VALUES
    (nextval('category_characteristics_seq'), 'Тип спорядження', 'STRING', (SELECT id FROM category_ids), 'Tents'),
...
INSERT INTO category_characteristics (id, name, data_type, category_id, category_name)
VALUES
    (nextval('category_characteristics_seq'), 'Тип сумки', 'STRING', (SELECT id FROM category_ids), 'Travel Accessories'),
    (nextval('category_characteristics_seq'), 'Об''єм', 'NUMBER', (SELECT id FROM category_ids), 'Travel Accessories'),
    (nextval('category_characteristics_seq'), 'Матеріал', 'STRING', (SELECT id FROM category_ids), 'Travel Accessories'),
    (nextval('category_characteristics_seq'), 'Функціональність', 'STRING', (SELECT id FROM category_ids), 'Travel Accessories'),
    (nextval('category_characteristics_seq'), 'Колір', 'STRING', (SELECT id FROM category_ids), 'Travel Accessories');
...
INSERT INTO category_characteristics (id, name, data_type, category_id, category_name)
VALUES
    (nextval('category_characteristics_seq'), 'Тип спорядження', 'STRING', (SELECT id FROM category_ids), 'Skateboards'),
...
INSERT INTO category_characteristics (id, name, data_type, category_id, category_name)
VALUES
    (nextval('category_characteristics_seq'), 'Тип спорядження', 'STRING', (SELECT id FROM category_ids), 'Mountaineering Gear'),
    (nextval('category_characteristics_seq'), 'Матеріал', 'STRING', (SELECT id FROM category_ids), 'Mountaineering Gear'),
    (nextval('category_characteristics_seq'), 'Рівень досвіду', 'STRING', (SELECT id FROM category_ids), 'Mountaineering Gear'),
    (nextval('category_characteristics_seq'), 'Мінімальна температура', 'NUMBER', (SELECT id FROM category_ids), 'Mountaineering Gear'),
    (nextval('category_characteristics_seq'), 'Вага', 'NUMBER', (SELECT id FROM category_ids), 'Mountaineering Gear');
...
INSERT INTO category_characteristics (id, name, data_type, category_id, category_name)
VALUES
    (nextval('category_characteristics_seq'), 'Тип спорядження', 'STRING', (SELECT id FROM category_ids), 'Climbing Shoes'),
...
INSERT INTO category_characteristics (id, name, data_type, category_id, category_name)
VALUES
    (nextval('category_characteristics_seq'), 'Тип одягу', 'STRING', (SELECT id FROM category_ids), 'Men Jackets'),
    ...
    (nextval('category_characteristics_seq'), 'Функціональність', 'STRING', (SELECT id FROM category_ids), 'Men Jackets');
...
INSERT INTO category_characteristics (id, name, data_type, category_id, category_name)
VALUES
    (nextval('category_characteristics_seq'), 'Тип головного убору', 'STRING', (SELECT id FROM category_ids), 'Men Headwear'),
...
INSERT INTO category_characteristics (id, name, data_type, category_id, category_name)
VALUES
    (nextval('category_characteristics_seq'), 'Тип головного убору', 'STRING', (SELECT id FROM category_ids), 'Women Headwear'),
...
INSERT INTO category_characteristics (id, name, data_type, category_id, category_name)
VALUES
    (nextval('category_characteristics_seq'), 'Тип велосипеда', 'STRING', (SELECT id FROM category_ids), 'Bikes'),
...
INSERT INTO category_characteristics (id, name, data_type, category_id, category_name)
VALUES
    (nextval('category_characteristics_seq'), 'Тип продукту', 'STRING', (SELECT id FROM category_ids), 'Proteins'),
    (nextval('category_characteristics_seq'), 'Кількість порцій', 'NUMBER', (SELECT id FROM category_ids), 'Proteins'),
...
INSERT INTO category_characteristics (id, name, data_type, category_id, category_name)
VALUES
    (nextval('category_characteristics_seq'), 'Тип аксесуара', 'STRING', (SELECT id FROM category_ids), 'Beach Accessories'),
    (nextval('category_characteristics_seq'), 'Матеріал', 'STRING', (SELECT id FROM category_ids), 'Beach Accessories'),
